<x-layouts::auth>
  ...
  >
    {{-- This is the left side (Registration Form) --}}
    <div
      x-show="show"
    ...
    >
        ...
        <a
            href="{{ route('home') }}"
            wire:navigate
            class="absolute top-6 left-6 text-zinc-400 transition-colors hover:text-orange-500 dark:text-zinc-600 dark:hover:text-orange-500"
        ...
        <div class="w-full max-w-sm space-y-8">
            <div class="space-y-2">
                <x-auth-header
                    ...
                    :description="__('Enter your details below to join GymWithin')"
                />
            </div>
    ...
    {{-- This is the Right side (Branding) --}}
    <div
      x-data="{ x: 0, y: 0 }"
