        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            <div class="lg:col-span-2">
                <div class="flex items-center space-x-3">
                    <a href="/" class="flex items-center space-x-3">
                        {{-- Replaced the gradient div with your actual logo --}}
                        <img src="{{ asset('Treadmill_Images/logo.png') }}" alt="GymWithin Logo"
                            class="w-auto h-20 md:h-20 object-contain">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Cardio
                            Equipment
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Strength
                            Training
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Bundles &
                            Packages
                        </a>
                    </li>
                </ul>
